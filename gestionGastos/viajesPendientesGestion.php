      ...
      <div class="container">
        <div class="nav nav-pills">
          <ul>
            ...
            <li><a href="viajesConfirmadosGestion.php">Viajes Confirmados</a></li>
            <li class="active"><a href="viajesPendientesGestion.php">Viajes Pendientes De Confirmación</a></li>
      ...
      <div class="container">
        <table class="tablaViajes">
          ...
          <tr>
            ...
            <td>Chicago</td> 
            <td>Aprobado</td>
            <td><button class="aceptarViaje">Pagado</button></td>
          </tr>
          <tr>
            <td>PAR7362920</td>
            <td>Mi Cliente</td>
